...
export default function CharacterCards() {
  return (
    <section className="flex flex-col items-center justify-center p-6 lg:p-12 min-h-screen bg-gradient-blur ">
      {/* Original content */}
      <div className=" sticky top-[0%] w-[90%] py-[4rem] flex flex-col gap-[2rem] items-center justify-center mb-12">
      ...
      {/* Card 1 */}
      <div className="card-before sticky top-[32%] bg-[url('/3.webp')] bg-cover bg-bottom w-[80%] lg:w-[60%] border border-[0.8px] border-w33 -skew-x-12 mb-8 ">
      ...
      {/* Card 2 */}
      <div className="card-before sticky top-[32%] bg-[url('/4.webp')] bg-cover bg-bottom w-[80%] lg:w-[60%] border border-[0.8px] border-w33 -skew-x-12 mb-8">
        <div className="flex justify-between gap-6 skew-x-12">
          <div className='flex flex-col pl-10 justify-center'>
          <div className="w-6 h-6 bg-white rounded-sm flex items-center justify-center mb-5">
            <img src="/" alt="" />
      ...
      {/* Card 3 */}
      <div className="card-before sticky top-[32%] bg-[url('/1.webp')] bg-cover bg-bottom w-[80%] lg:w-[60%] border border-[0.8px] border-w33 -skew-x-12 mb-8">
        <div className="flex justify-between gap-6 skew-x-12">
          <div className='flex flex-col pl-10 justify-center'>
          <div className="w-6 h-6 bg-white rounded-sm flex items-center justify-center mb-5">
            <img src="/" alt="" />
      ...
      {/* Card 4 */}
      <div className="card-before sticky top-[32%] bg-[url('/5.webp')] bg-cover bg-bottom w-[80%] lg:w-[60%] border border-[0.8px] border-w33 -skew-x-12 mb-8">
        <div className="flex justify-between gap-6 skew-x-12">
          <div className='flex flex-col pl-10 justify-center'>
          <div className="w-6 h-6 bg-white rounded-sm flex items-center justify-center mb-5">
            <img src="/" alt="" />
      ...
      {/* Card 5 */}
      <div className="card-before sticky top-[32%] bg-[url('/2.webp')] bg-cover bg-bottom w-[80%] lg:w-[60%] border border-[0.8px] border-w33 -skew-x-12 mb-8">
        <div className="flex justify-between gap-6 skew-x-12 ">
          <div className='flex flex-col pl-10 justify-center'>
          <div className="w-6 h-6 bg-white rounded-sm flex items-center justify-center mb-5">
            <img src="/" alt="" />
